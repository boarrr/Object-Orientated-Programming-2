...
public class Car {
    ...
    public String toString() {
       return "The car with registration " + regNumber + " is owned by " + ownerName + ". It is " + carColor + ", has max speed of " + maxSpeed + ", " + wheelCount + " wheels, and automatic gear: " + automatic; 
    }
}
